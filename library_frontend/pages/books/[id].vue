    ...
    <div class="card" style="padding: 1rem;">
      <div style="display:grid; grid-template-columns: 220px 1fr; gap: 1rem;">
        ...
        <div>
          ...
          <div style="display:flex; gap:.35rem; flex-wrap:wrap; margin-bottom:.75rem;" v-if="book.tags?.length">
          ...
          <p style="margin-top:.75rem; white-space: pre-wrap;">{{ book.description }}</p>
...
.rating { color: #f59e0b; }
.star { opacity:.35; font-size:1.1rem; }
